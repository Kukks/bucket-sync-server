...
public class HashingTests
{
    ...
    {
        var a = new BucketEntry("b", "k1", 1, 1, "h1", "cse-v1", false, new byte[] { 1 }, default);
        var c = new BucketEntry("b", "k2", 1, 1, "h2", "cse-v1", false, new byte[] { 2 }, default);
        Assert.Equal(
    ...
    {
        var v1 = new BucketEntry("b", "k", 1, 1, "h", "cse-v1", false, new byte[] { 1 }, default);
    ...
    {
        var live = new BucketEntry("b", "k", 1, 1, "h", "cse-v1", false, new byte[] { 1 }, default);
